...
export function guardarCantidadPedidosClientePorFechasAction(intervaloFechas) {
  return async (dispatch) => {
    try {
      ...
      const header = authorizationHeader(token);
      await clienteAxios
        .get(`/api/order-detail/orders-client`, {
          params: { ...intervaloFechas },
          ...header,
        })
        .then(async (response) => {
...
export function obtenerFacturasAction() {
  return async (dispatch) => {
    try {
      const token = localStorage.getItem("token");
      const header = authorizationHeader(token);
      await clienteAxios.get(`/api/bill`, header).then((response) => {
...
export function editarConfiguracionAction(datosConfiguracion) {
  return async (dispatch) => {
    try {
      ...
      await clienteAxios
        .put(
          `/api/config/${datosConfiguracion._id}`,
          datosConfiguracion,
          header
        )
        .then((response) => {
...
export function obtenerConfiguracionAction() {
  return async (dispatch) => {
    try {
      ...
      await clienteAxios.get(`/api/config`, header).then((response) => {
        dispatch(obtenerDatoConfiguracion(response.data.config));
      });
    } catch (err) {
      console.log(err);
      dispatch(
        descargarConfiguracionError("Error al obtener la configuracion")
      );
    }
  };
}
...
export function obtenerMenuPorIdAction(idMenu) {
  return async (dispatch) => {
    try {
      const token = localStorage.getItem("token");
      const header = authorizationHeader(token);
      await clienteAxios.get(`/api/menu/${idMenu}`, header).then((response) => {
...
export function obtenerProductoPorIdAction(idInsumo) {
  return async (dispatch) => {
    try {
      ...
      const header = authorizationHeader(token);
      await clienteAxios
        .get(`/api/product/${idInsumo}`, header)
        .then((response) => {
...
export function abrirCerrarModalDetallePedidoAction(
  estadoModalNroOrden,
  orden
) {
  return (dispatch) => {
...
export function obtenerIngredientesAction() {
  return async (dispatch) => {
    try {
      const token = localStorage.getItem("token");
      const header = authorizationHeader(token);
      await clienteAxios.get(`/api/menudetail`, header).then((response) => {
        dispatch(descargarListadoMenuDetalleExito(response.data.menudetails));
      });
    } catch (err) {
      console.log(err);
      dispatch(
        descargarMenuDetalleError("Error al descargar los menu detalle")
      );
    }
  };
}
...
export function editarOrdenAction(nuevaOrden, facturas) {
  return async (dispatch) => {
    ...
    try {
      ...
      await clienteAxios
        .put(`/api/order/${nuevaOrden._id}`, nuevaOrden, header)
        .then((response) => {
...
export function obtenerPedidosAction() {
  return async (dispatch) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const header = authorizationHeader(token);
      await clienteAxios.get("/api/order", header).then((response) => {
...
export function obtenerInsumoBuscadorAction(
  indexPrimerUsuario,
  limit,
  pagina,
  palabraBusqueda
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      await clienteAxios
        .get(
          `/api/product/search/${palabraBusqueda}?from=${indexPrimerUsuario}&limit=${limit}`,
          header
        )
        .then((response) => {
...
export function obtenerCategoriasInsumoBuscadorAction(
  indexPrimerUsuario,
  limit,
  pagina,
  palabraBusqueda
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      await clienteAxios
        .get(
          `/api/product-categories/search/${palabraBusqueda}?from=${indexPrimerUsuario}&limit=${limit}`,
          header
        )
        .then((response) => {
          const datosPaginacion = {
      ...
      console.log(error);
      dispatch(
        descargarCategoriasInsumoError(
          "Error al buscar las categorias de insumo"
        )
      );
    }
  };
...
export function obtenerMenusBuscadorAction(
  indexPrimerUsuario,
  limit,
  pagina,
  palabraBusqueda
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      await clienteAxios
        .get(
          `/api/menu/search/${palabraBusqueda}?from=${indexPrimerUsuario}&limit=${limit}`,
          header
        )
        .then((response) => {
          const datosPaginacion = {
...
export function obtenerCategoriasBuscadorAction(
  indexPrimerUsuario,
  limit,
  pagina,
  palabraBusqueda
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      await clienteAxios
        .get(
          `/api/menu-categories/search/${palabraBusqueda}?from=${indexPrimerUsuario}&limit=${limit}`,
          header
        )
        .then((response) => {
          const datosPaginacion = {
...
export function obtenerUsuariosBuscadorAction(
  indexPrimerUsuario,
  limit,
  pagina,
  palabraBusqueda
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      await clienteAxios
        .get(
          `/api/users/search/${palabraBusqueda}?from=${indexPrimerUsuario}&limit=${limit}`,
          header
        )
        .then((response) => {
          const datosPaginacion = {
  ...
  return async (dispatch) => {
    try {
      ...
      if (imageFile !== null) {
        ...
        await clienteAxios
          .put(`/api/upload/products/${datos_insumos._id}`, formData, header)
          .then((response) => {
            clienteAxios.put(
              `/api/product-categories/${response.data.result._id}`,
        ...
        await clienteAxios
          .put(`/api/product/${datos_insumos._id}`, datos_insumos, header)
          .then((response) => {
...
export function eliminarInsumoAction(datos_insumos) {
  return async (dispatch) => {
    ...
    try {
      ...
      Swal.fire("Eliminado!", "El insumo se eliminó correctamente.", "success");
    } catch (err) {
      console.log(err);
...
export function obtenerInsumosAction() {
  return async (dispatch) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const header = authorizationHeader(token);
      await clienteAxios.get(`/api/product`, header).then((response) => {
...
export function crearNuevaInsumoAction(datosNuevoInsumo, imageFile) {
  return async (dispatch) => {
    ...
    try {
      ...
      if (imageFile !== null) {
        await clienteAxios
          .post("/api/product", datosNuevoInsumo, header)
          .then((response) => {
            const formData = new FormData();
            formData.append("file", imageFile.img);
            if (!response.data.productStored) {
              ...
              clienteAxios.put(
                `/api/upload/products/${product._id}`,
                formData,
                header
              );
              ...
              clienteAxios.put(
                `/api/upload/products/${productStored._id}`,
                formData,
                header
              );
...
export function editarCategoriaInsumoAction(
  datos_categoria_insumos,
  imageFile
) {
  return async (dispatch) => {
    ...
    try {
      ...
      if (imageFile !== null) {
        ...
        await clienteAxios
          .put(
            `/api/upload/product-categories/${datos_categoria_insumos._id}`,
            formData,
            header
          )
          .then((response) => {
        ...
        await clienteAxios
          .put(
            `/api/product-categories/${datos_categoria_insumos._id}`,
            datos_categoria_insumos,
            header
          )
          .then((response) => {
...
export function eliminarCategoriaInsumoAction(datos_categoria_insumos) {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log(err);
      dispatch(
        categoriaInsumoEliminadoError("Error al eliminar el categoria insumo")
      );
    }
  };
}
...
export function obtenerCategoriaInsumoAction() {
  return async (dispatch) => {
    ...
    try {
      ...
      const header = authorizationHeader(token);
      await clienteAxios
        .get(`/api/product-categories`, header)
        .then((response) => {
      ...
      dispatch(
        descargarCategoriasInsumoError(
          "Error al descargar las categorias insumo"
        )
      );
    }
  };
...
export function obtenerCategoriaInsumoFiltradasPorParentAction(idParent) {
  return async (dispatch) => {
    ...
    try {
      ...
      const header = authorizationHeader(token);
      await clienteAxios
        .get(`/api/product-categories/filter/${idParent}`, header)
        .then((response) => {
          dispatch(obtenerListadoCategoriasInsumo(response.data));
        });
    } catch (err) {
...
export function crearNuevaCategoriaInsumoAction(
  datosNuevoCategoriaInsumo,
  imageFile
) {
  return async (dispatch) => {
    ...
    try {
      ...
      if (imageFile !== null) {
        await clienteAxios
          .post("/api/product-categories", datosNuevoCategoriaInsumo, header)
          .then((response) => {
            const formData = new FormData();
            formData.append("file", imageFile.img);
            if (!response.data.productCategoryStored) {
              ...
              clienteAxios.put(
                `/api/upload/product-categories/${productCategory._id}`,
                formData,
                header
              );
              ...
              clienteAxios.put(
                `/api/upload/product-categories/${productCategoryStored._id}`,
                formData,
                header
              );
...
export function abrirCerrarAgregarCategoriaInsumoAction(
  estadoAgregarCategoriaInsumo
) {
  return (dispatch) => {
...
export function editarMenuAction(
  datos_menu,
  imageFile,
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      if (imageFile !== null) {
        ...
        await clienteAxios
          .put(`/api/upload/menus/${datos_menu._id}`, formData, header)
          .then((response) => {
            clienteAxios.put(
              `/api/menu/${response.data.result._id}`,
              datos_menu,
              header
            );
            ...
            for (const ingrediente of ingredientesIniciales) {
              if (ingrediente.menu._id === datos_menu._id) {
                clienteAxios.delete(
                  `/api/menudetail/${ingrediente._id}`,
                  header
                );
              }
            }
        ...
        clienteAxios
          .put(`/api/menu/${datos_menu._id}`, datos_menu, header)
          .then((response) => {
...
export function eliminarMenuAction(datos_menu, ingredientesDB) {
  return async (dispatch) => {
    ...
    try {
      ...
      const header = authorizationHeader(token);
      await clienteAxios
        .delete(`/api/menu/${datos_menu._id}`, header)
        .then((response) => {
...
export function obtenerMenuAction() {
  return async (dispatch) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const header = authorizationHeader(token);
      await clienteAxios.get(`/api/menu/menuAll`, header).then((response) => {
...
export function crearNuevoMenuAction(datosNuevoMenu, imageFile, ingredientes) {
  return async (dispatch) => {
    ...
    try {
      ...
      if (imageFile !== null) {
        await clienteAxios
          .post("/api/menu", datosNuevoMenu, header)
          .then((response) => {
            const formData = new FormData();
            formData.append("file", imageFile.img);
            ...
            if (!response.data.menuStored) {
              ...
              clienteAxios.put(
                `/api/upload/menus/${menuStored._id}`,
                formData,
                header
              );
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      if (imageFile !== null) {
        ...
        await clienteAxios
          .put(
            `/api/upload/menu-categories/${datos_categoria._id}`,
            formData,
            header
          )
          .then((response) => {
            clienteAxios.put(
              `/api/menu-categories/${response.data.result._id}`,
              response.data.result,
              header
            );
        ...
        await clienteAxios
          .put(
            `/api/menu-categories/${datos_categoria._id}`,
            datos_categoria,
            header
          )
          .then((response) => {
...
export function obtenerCategoriasAction() {
  return async (dispatch) => {
    ...
    try {
      ...
      await clienteAxios
        .get(`/api/menu-categories`, header)
        .then((response) => {
...
export function crearNuevaCategoriaAction(datosNuevaCategoria, imageFile) {
  return async (dispatch) => {
    ...
    try {
      ...
      if (imageFile !== null) {
        await clienteAxios
          .post("/api/menu-categories", datosNuevaCategoria, header)
          .then((response) => {
            const formData = new FormData();
            formData.append("file", imageFile.img);
            ...
            if (!response.data.menuCategoryStored) {
              ...
              clienteAxios.put(
                `/api/upload/menu-categories/${category._id}`,
                formData,
                header
              );
              ...
              clienteAxios.put(
                `/api/upload/menu-categories/${menuCategoryStored._id}`,
                formData,
                header
              );
...
export function editarUsuarioAction(datos_usuario) {
  return async (dispatch) => {
    ...
    try {
      ...
      const header = authorizationHeader(token);
      await clienteAxios.put(
        `/api/users/admin/${datos_usuario._id}`,
        datos_usuario,
        header
      );
...
export function obtenerUsuariosAction() {
  return async (dispatch) => {
    ...
    try {
      ...
      await clienteAxios.get(`/api/users`, header).then((response) => {
