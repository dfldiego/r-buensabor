    ...
    return (
        <Fragment>
            ...
            <div className="dos-columnas-admin">
                ...
                <div>
                    {!en_usuario_state_store && !en_menu_state_store && !en_categoria_state_store && !entrar_categoria_insumos_store && !en_insumos_state_store && !entrar_pedidos_store ? <h1>Página de Administración</h1> : null}
