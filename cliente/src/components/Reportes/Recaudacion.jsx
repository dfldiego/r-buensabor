...
//Actions de Redux
import {
    guardarFechasReporteRecaudacionAction,
...
const Recaudacion = () => {
    ...
    const guardarFechasReporteRecaudacion = intervaloFechas => dispatch(guardarFechasReporteRecaudacionAction(intervaloFechas));
    ...
    const handleSubmitExportarExcel = e => {
        ...
        guardarFechasReporteRecaudacion(fechas);
    }

    return (
        <Fragment>
            <main className="container">
                <h1 className="titulo">Recaudación</h1>
